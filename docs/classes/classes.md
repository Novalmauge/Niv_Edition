...
| **Ranger** | A mixed martial class that that has access to nature based casting | Dexterity, Wisdom | SRD |
| **Rogue** | A martial class that uses stealth and subterfuge | Dexterity, Intelligence | SRD | 
| **Sentinel(warden)** | A martial class that focuses on defending others from harm | Strength, Constitution | Mage Hand Press |
| **Sorcerer** | A spellcaster that uses magic they were born with, or have learned to use innately | Constitution, Charisma | SRD |
| **Spellblade** | A rare hybrid class that enhances their marital abilities with magic | Dexterity, Constitution, Dexterity | KCLL |
| **Talent** | A psionic based caster that uses the power of their mind to manipulate reality | Constitution, Intelligence | MCDM |
| **Tamer** | A spellcaster class that has the ability to tame monsters and empower them | Intelligence, Wisdom or Charisma | Heliana |
| **Warden** | A defender martial class that channels primal energies to reinforce themselves | Constitution, Wisdom | KCLL |
| **Warlock** | A spell caster that channels power granted from another entity | Constitution, Charisma | KCLL |
